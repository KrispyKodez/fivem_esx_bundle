[hub]: https://hub.docker.com/r/KrispyKodez/fivem_esx_bundle
[git]: https://github.com/Andruida/fivem

# [KrispyKodez/fivem_esx_bundle][hub] <img align="right" height="250px" src="https://portforward.com/fivem/fivem-logo.png">
...
[![Docker Stars](https://img.shields.io/docker/stars/KrispyKodez/fivem_esx_bundle.svg)][dockerhub]
[![Donate](https://img.shields.io/badge/Donate-PayPal-green.svg)](https://www.paypal.com/paypalme/KrispyKodez)
...
# -------------------------------------------------------------------
  fivem:
    image: KrispyKodez/fivem_esx_bundle
    stdin_open: true
    tty: true
    volumes:
      # Remember to change.
...
# -------------------------------------------------------------------
  fivem01:
    image: KrispyKodez/fivem_esx_bundle:light
    stdin_open: true
    tty: true
    volumes:
      # Remember to change.
